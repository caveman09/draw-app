...
>(({ className, ...props }, ref) => {
  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        "fixed inset-0 z-40 data-[state=open]:animate-in data-[state=closed]:animate-out",
        className
      )}
      {...props}
    />
  ...
  "fixed z-40 gap-4 bg-background p-6 shadow-lg transition-all ease-in-out data-[state=closed]:duration-500 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        topleft: "inset-x-2 inset-y-2 border-r data-[state=closed]:w-8 data-[state=closed]:h-8 data-[state=open]:w-8 data-[state=open]:h-8 sm:max-w-sm",
        activated: "inset-x-2 inset-y-2 border-r data-[state=closed]:w-8 data-[state=closed]:h-8 data-[state=open]:w-[400px] data-[state=open]:h-[400px] sm:max-w-sm"
      },
    },
    defaultVariants: {
      side: "right",
